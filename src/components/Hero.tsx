    ...
    <section className="w-full mt-4 sm:mt-6">
      <div className="max-w-[var(--content-max-width)] mx-auto text-left">
        <motion.p
          ...
          className="font-accent text-xs uppercase tracking-widest text-[var(--fg-brand-aperol)] mb-4 sm:mb-5"
        >
        ...
        <TextBlockReveal
          ...
          delay={0.1}
          stagger={0.15}
          className="font-display font-bold text-[var(--fg-primary)] leading-[1.1] tracking-tight text-3xl sm:text-4xl lg:text-6xl mb-5 sm:mb-7"
        >
          Brand. Code. Creative.
        </TextBlockReveal>
